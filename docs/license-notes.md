...
本教材整理自 IBM Learn 課程 `Introducing z/OS Unix System Services`，作為台灣繁體中文靜態學習版本。

- 課程來源：IBM Learn `Introducing z/OS Unix System Services`
- 課程網址：https://learn.ibm.com/course/view.php?id=9890
